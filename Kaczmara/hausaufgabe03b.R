# Hausaufgabe 03
# Anja Kaczmarek <Kaczmara@staff.uni-marburg.de>
# 2014-04-27
...
# Häufigkeiten entst ehen: tabelle.prozent <- quantile(tabelle.rel) code_hier 
...
# Es gibt nicht immer nur einen Modalwert, der Modus ist immer der höchste Wert, der einer Variablen zugeordnet ist.
